      ...
      {showLocationPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 w-11/12 max-w-md shadow-lg">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Location Required</h2>
            <p className="text-sm text-gray-600 mb-4">
              To find nearby hospitals, we need access to your location. Please enable location services in your browser settings and refresh the page.
            </p>
