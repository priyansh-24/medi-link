...
import { AlertTriangle, Phone, MapPin, Navigation, Clock, Heart, Ambulance } from 'lucide-react';
  ...
  const nearbyHospitals = [
    {
      ...
      address: '123 Hospital Ave, City Center',
      distance: '2.3 miles',
      phone: '(555) 123-4567',
    ...
    },
    {
      ...
      distance: '3.1 miles',
      phone: '(555) 234-5678',
      emergencyWait: '22 min',
      rating: 4.6,
      specialties: ['Emergency Medicine', 'Pediatrics', 'Neurology']
    },
    {
      name: 'Regional Trauma Center',
      address: '789 Trauma Dr, Medical District',
      distance: '4.2 miles',
      phone: '(555) 345-6789',
      emergencyWait: '18 min',
      rating: 4.9,
      specialties: ['Level 1 Trauma', 'Emergency Surgery', 'Critical Care']
    }
  ];
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">
                  <strong>Emergency Protocol:</strong> If this is a life-threatening emergency, call 911 immediately. 
                  For non-urgent medical needs, use the options below to find appropriate care.
                </p>
              </div>
            </div>
          </div>
            ...
            {quickActions.map((action, index) => {
              ...
              return (
                <button
                  ...
                  className={`${action.color} hover:opacity-90 text-white rounded-lg p-4 text-center transition-all duration-200 transform hover:scale-105`}
                >
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center text-gray-600 mb-2">
                        ...
                        <span className="text-sm ml-2 text-blue-600">({hospital.distance})</span>
                      </div>
